...
if __name__ == '__main__':   
	...
	feats = ['', '_multiobjective', '_constrained'] 
	feat = feats[1]
	
	configs = [f'./config/cep{feat}/CEP_GP_full_0.json',
				f'./config/cep{feat}/CEP_GP_pca_0.json',
				#f'./config/cep{feat}/CEP_Random_0.json',
				#f'./config/cep{feat}/CEP_SAAS_0.json',
				]
